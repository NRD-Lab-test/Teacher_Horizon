...
class MobileTotalPointCounter extends(React.Component){
    ...
    render(){
        return (<div style={{ position:"absolute",width:"38vh",height:"8vh",border:`solid ${this.props.borderColor} .5vh`,fontSize:"3.5vh",textAlign:"center",top:"3.5vh",left:"calc(50vw - 17.5vh)"}}>
...
export default MobileTotalPointCounter